...
class AlizePHP {
	...
	public function __construct($speaker, $audio_file_path) {
		...
		if (!file_exists($audio_file_path)) throw new AlizePHPException("Original audio file missing.");
	...
	public function extractFeatures ($param_string = null) {
		if (!file_exists($this->getOriginalAudioFile()))
			throw new AlizePHPException("Original audio file missing.");
